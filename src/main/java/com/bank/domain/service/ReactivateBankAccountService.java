...
/** Servicio de dominio: Reactivar una cuenta bloqueada. */
...
public class ReactivateBankAccountService {
    ...
    public ReactivateBankAccountService(BankAccountRepositoryPort ar, OperationLogRepositoryPort al) {
    ...
    public BankAccount execute(String accountNumber, Long operatorUserId) {
        ...
        auditLog.save(OperationLog.create("ACCOUNT_REACTIVATED", operatorUserId, "OPERATOR",
