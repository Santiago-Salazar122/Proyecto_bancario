...
/** Servicio de dominio: Retirar de una cuenta. */
@Service
@Transactional
public class WithdrawFromBankAccountService {
    ...
    public WithdrawFromBankAccountService(BankAccountRepositoryPort ar, OperationLogRepositoryPort al) {
    ...
    public BankAccount execute(String accountNumber, Money amount, Long operatorUserId) {
        ...
        auditLog.save(OperationLog.create("WITHDRAWAL", operatorUserId, "TELLER_EMPLOYEE",
